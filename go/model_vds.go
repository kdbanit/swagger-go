...
type Vds struct {
	...
	Software *VdsSoftware `json:"software"`
	// Уникальный идентификатор тарифа сервера.
	PresetId float64 `json:"preset_id"`
	// Локация сервера.
	Location string `json:"location"`
	// Уникальный идентификатор конфигуратора сервера.
	ConfiguratorId float64 `json:"configurator_id"`
	...
	Image *VdsImage `json:"image"`
	// Список сетей диска.
	Networks []VdsNetworks `json:"networks"`
	// Cloud-init скрипт.
