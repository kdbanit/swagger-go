...
type DomainRequest struct {
	...
	DomainBundleId string `json:"domain_bundle_id"`
	// Код ошибки трансфера домена.
	ErrorCodeTransfer string `json:"error_code_transfer"`
	// Полное имя домена.
